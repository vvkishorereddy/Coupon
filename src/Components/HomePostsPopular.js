...
export class HomePostsPopular extends Component {
  render() {
    return (
        <div id="popular" className="tab-pane counties-pane active animated fadeIn">
          ...
          <div className="coupon-wrapper row">
            ...
            <div className="coupon-contain col-sm-7">
              <ul className="list-inline list-unstyled">
                ...
                <li className="label label-info">In store</li>
              ...
              <p id={1} className="collapse">Don't miss out on all the coupon savings.Get you coupon now and save big</p>
          ...
          <div className="coupon-wrapper row featured">
            ...
            <div className="coupon-contain col-sm-7">
              ...
              <p id="more" className="collapse">Don't miss out on all the coupon savings.Get you coupon now and save big</p>
              <ul className="coupon-details list-inline">
                <li className="list-inline-item">
                  <div className="btn-group" role="group" aria-label="...">
                    <button type="button" className="btn btn-default btn-xs" data-toggle="tooltip" data-placement="left" title data-original-title="It worked"><i className="ti-thumb-up" /> </button>
          ...
          <div className="coupon-wrapper row">
            ...
            <div className="coupon-contain col-sm-7">
              ...
              <p id="more1" className="collapse">Don't miss out on all the coupon savings.Get you coupon now and save big</p>
              <ul className="coupon-details list-inline">
                <li className="list-inline-item">
                  <div className="btn-group" role="group" aria-label="...">
                    <button type="button" className="btn btn-default btn-xs" data-toggle="tooltip" data-placement="left" title data-original-title="It worked"><i className="ti-thumb-up" /> </button>
          ...
          <div className="coupon-wrapper row">
            ...
            <div className="coupon-contain col-sm-7">
              ...
              <p id="more-1" className="collapse">Don't miss out on all the coupon savings.Get you coupon now and save big</p>
              <ul className="coupon-details list-inline">
                <li className="list-inline-item">
                  <div className="btn-group" role="group" aria-label="...">
                    <button type="button" className="btn btn-default btn-xs" data-toggle="tooltip" data-placement="left" title data-original-title="It worked"><i className="ti-thumb-up" /> </button>
...
export default HomePostsPopular
